...
public class JavaServiceGen extends BeetlGen {

    private final Home home;

    public JavaServiceGen(Home home, String tplRootPath, GroupTemplate groupTemplate) {
    ...
    public void make(Way way) {
        ...
        Template template = gt.getTemplate(tplRootPath + "/service.java");
    ...
    public String getFileName() {
        return home.getClassName() + "Service.java";
    }
}
