...
import com.dsp.soy.auth.exception.UaaAccessDeniedHandler;
import com.dsp.soy.auth.exception.UaaAuthExceptionEntryPoint;
import com.dsp.soy.auth.exception.UaaWebResponseExceptionTranslator;
import com.dsp.soy.auth.filter.UaaClientCredentialsTokenEndpointFilter;
import com.dsp.soy.auth.grant.EmailTokenGranter;
import com.dsp.soy.auth.grant.SmsTokenGranter;
import com.dsp.soy.auth.model.User;
import com.dsp.soy.auth.service.EmailUserDetailsService;
